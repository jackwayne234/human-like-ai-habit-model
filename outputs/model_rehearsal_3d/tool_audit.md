# Model Rehearsal 3D Tool Audit

| tick | tool | result | detail |
| --- | --- | --- | --- |
| 0 | requestRawDetail | denied | bootstrap model rehearsal asks whether exact 3d geometry is available |
...
| 5 | writeMapBelief3D | ok | local_3d_passage: compact risk memory is being tested |
| 5 | readCompactSensors3D | ok | compact 3d trigger stream n^-2 rising |
...
| 10 | writeMapBelief3D | ok | local_3d_passage: compact risk memory is being tested |
| 10 | readCompactSensors3D | ok | compact 3d trigger stream n^-2 rising |
